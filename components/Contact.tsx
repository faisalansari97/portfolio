...
export const Contact = () => {
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 pb-1 text-center">
        ...
        <p className="text-md md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          I'm currently available for freelance projects and full-time
          opportunities. If you're interested in building something scalable and
          user-centric, let's connect.
        </p>

        <div className="flex sm:flex-row gap-2 md:gap-4 justify-center items-center mb-16">
          <a
            href={`mailto:${PERSONAL_INFO.email}`}
            className=" sm:w-auto px-4 md:px-8 py-2 md:py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold text-sm md:text-lg transition-all shadow-lg hover:shadow-primary-500/25 hover:-translate-y-1 flex items-center justify-center gap-2"
          >
            <Mail size={20} />
            Say Hello
          </a>
