      ...
      <div className="max-w-4xl mx-auto px-4 pb-1 text-center">
        ...
        <div className="flex md:flex-col sm:flex-row gap-2 md:gap-4 justify-center items-center mb-16">
          <a
            ...
            className="md:w-full sm:w-auto px-4 md:px-8 py-2 md:py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold text-md md:text-lg transition-all shadow-lg hover:shadow-primary-500/25 hover:-translate-y-1 flex items-center justify-center gap-2"
          >
            <Mail size={20} />
            Say Hello
          </a>
